...
create_generated_clock -name {pll_clk} -source [get_pins {sys_inst|hyperram_controller_0|pll2_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 1 -master_clock {refclk} [get_pins {sys_inst|hyperram_controller_0|pll2_inst|altpll_component|auto_generated|pll1|clk[0]}] 
create_generated_clock -name {pll_clk90} -source [get_pins {sys_inst|hyperram_controller_0|pll2_inst|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 1 -phase 90 -master_clock {refclk} [get_pins {sys_inst|hyperram_controller_0|pll2_inst|altpll_component|auto_generated|pll1|clk[1]}]
#**************************************************************
# Set Clock Latency
#**************************************************************
